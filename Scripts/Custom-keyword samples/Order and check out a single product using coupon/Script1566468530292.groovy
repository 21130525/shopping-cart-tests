...
WebUI.waitForElementPresent(findTestObject('tam/Pages/Shop page/lnkShop'), GlobalVariable.waitPresentTimeout)

WebUI.click(findTestObject('tam/Pages/Shop page/lnkShop'))
